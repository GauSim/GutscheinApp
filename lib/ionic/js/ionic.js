...
(function(ionic) {
  ...
  ionic.Gestures.PointerEvent = {
    ...
    /**
     * create the position of a pointer
...
function viewportUpdate() {
  ...
  // only create the viewport tag if there was a change
  ...
  zyngaCore.effect.Animate = {
    ...
    start: function(stepCallback, verifyCallback, completedCallback, duration, easingMethod, root) {
      ...
      var step = function(virtual) {
        ...
        // For the current rendering to apply let's create omitted steps in memory.
...
ionic.views.Scroll = ionic.views.View.inherit({
  initialize: function(options) {
    ...
    // Get the render create function, initialize event handlers,
  ...
  __initEventHandlers: function() {
    ...
    self.scrollChildIntoView = function(e) {
      ...
      if( e.detail.isElementUnderKeyboard ) {
        ...
        //Wait for android to create view height and resize() to reset scroll position
  ...
  */
  ...
  setDimensions: function(clientWidth, clientHeight, contentWidth, contentHeight) {
    ...
    // Only create values which are defined
